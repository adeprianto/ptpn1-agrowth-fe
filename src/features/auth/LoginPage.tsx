...
import { ArrowRight, Eye, EyeOff, Lock, Sprout, Loader2 } from "lucide-react";
...
export function LoginPage() {
  ...
  // 1. Add useTransition to get the loading state (isPending)
      ...
      <div className="flex min-h-screen bg-white">
        ...
        <div className="relative hidden w-full max-w-xl flex-col justify-between overflow-hidden bg-linear-to-br from-emerald-600 via-emerald-800 to-emerald-950 p-10 text-white lg:flex">
          ...
          <div className="relative flex items-center gap-3">
            <div className="h-12 w-12 shrink-0 rounded-xl bg-white/20 flex items-center justify-center">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              <div>
                ...
                <input
                    ...
                    required
                    disabled={isPending}
                    className="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm text-slate-700 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 disabled:opacity-60 disabled:bg-slate-50"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                      ...
                      required
                      disabled={isPending}
                      className="w-full rounded-lg border border-slate-300 px-3 py-2.5 pr-10 text-sm text-slate-700 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 disabled:opacity-60 disabled:bg-slate-50"
                  />
                  <button
                      type="button"
                      disabled={isPending}
              ...
              {/* 3. Disable button and show spinner based on isPending */}
              <button
                  type="submit"
                  disabled={isPending}
