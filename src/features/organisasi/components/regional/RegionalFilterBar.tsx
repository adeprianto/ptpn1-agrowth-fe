...
// Filter Wilayah & Jumlah Unit sementara dilepas: kolom wilayah belum ada di
// tabel entities, dan filter jumlah unit belum didukung endpoint /regionals.
    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center ">
      <div className="relative flex-1 ">
        ...
        <input
          ...
          placeholder="Cari nama atau kode regional..."
