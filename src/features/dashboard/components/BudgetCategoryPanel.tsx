...
const labelPilihan = (value: Pilihan) =>
  value === "ALL" ? "Semua Entity" : formatEntityName(value);
  ...
  return (
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
      <DashboardCard
        ...
        subtitle={`Realisasi tiap kategori terhadap anggaran — ${labelPilihan(entity)}`}
        headerAction={select}
      >
      ...
      <DashboardCard
        title="Total Anggaran Tersedia"
        subtitle={`Anggaran RKAP, realisasi, dan sisa — ${labelPilihan(entity)}`}
